...
class TrafficStateContextKGDataset(TrafficStateDataset):
    ...
    def get_kge_template(self):
        ...
        # area list
        # arealab_list = []
        # for _elem_id in list(df_auxi[0, :, 3]):  # area_id list
        #     arealab_list.append('area_' + str(int(_elem_id)))
        ...
        # area_spat_id = kg_entity_id_from_list(tf_spat, arealab_list)
        # spat_kge path
        ...
        # area_temp_id = kg_entity_id_from_list(tf_temp, arealab_list)
        # temp_kge path
