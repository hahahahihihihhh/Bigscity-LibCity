        ...
        for epoch_idx in range(self._epoch_num, self.epochs):
            ...
            if val_loss < min_val_loss:
                ...
                if self.saved:
                    ...
                    if best_model_path and best_model_path != model_file_name and os.path.exists(best_model_path):
                        os.remove(best_model_path)
                    self._logger.info('Val loss decrease from {:.4f} to {:.4f}, '
                                      'saving to {}, removing {}'.format(min_val_loss, val_loss, model_file_name, best_model_path))
                    best_model_path = model_file_name
